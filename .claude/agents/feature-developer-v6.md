...
> Retained for projects on Opus-class models. Where `claude-fable-5` is
> available, prefer `feature-developer-v7` — it replaces the bot-watcher
> sub-agent used below with inline ScheduleWakeup polling.
