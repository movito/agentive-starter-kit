...
```bash
ls .kit/delegation/tasks/2-todo/ 2>/dev/null | head -10 || echo "No tasks in 2-todo/"
```

```bash
ls .kit/delegation/tasks/3-in-progress/ 2>/dev/null | head -10 || echo "None in progress"
```
