...
| E5 | Table-row regex breaks on indentation | o3 | **ACCEPTED** — allowed leading whitespace and constrained the match to the row's own cell (a negated-pipe character class). Falsified once. |
