...
- `.kit/context/workflows/COMMIT-PROTOCOL.md` - Removed ci-checker Option 1; fixed usage syntax to use `--wait`/`--timeout` flags; updated checklist references
...
- **Bug report**: `/Volumes/Macintosh HD/Users/broadcaster_three/Github/dispatch-kit/.kit/context/reports/ci-checker-bash-permission-bug.md`
