...
- **o3's FAIL verdict is 3-for-3 on real blockers this arc** (env dup-key, shape-reader fail-loud, deletion divergence): treat an o3 FAIL as default-serious at the verdict level, while its individual claims still get verify-before-believing — the same evaluator produces both the arc's best catches and its most confident falsehoods. (KIT-0046/0048/0049)
