...
- **`.adversarial/inputs/` is now gitignored** (regenerable; review records live in `.kit/context/reviews/`) — clean evaluator sessions leave clean worktrees; preserve-then-force is the fallback, not the routine. (KIT-0046 retro, planner decision)
