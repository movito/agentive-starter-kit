...
2. **Helper Commands** - `./scripts/core/project teams` for debugging
...
./scripts/core/project linearsync
# or
./scripts/core/project sync  # alias
```
...
- Test: `./scripts/core/project teams`
...
- Run `./scripts/core/project teams` to see available teams
...
- Use `./scripts/core/project teams` to find correct KEY
...
7. [ ] **Test sync runs successfully** (`./scripts/core/project linearsync`)
...
- `./scripts/core/project linearsync` works without LINEAR_TEAM_ID
- Auto-detects and prints team name/UUID
- Creates/updates issues successfully

✅ **Multi-team workspace**:
- `./scripts/core/project teams` lists all teams
