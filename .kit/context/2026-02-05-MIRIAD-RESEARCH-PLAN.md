...
|----------|----------|---------|
| Research notes | `.kit/context/research/miriad/` | Raw findings |
| Architecture summary | `.kit/context/research/miriad/ARCHITECTURE.md` | High-level overview |
...
4. **Create research directory** - `.kit/context/research/miriad/`
