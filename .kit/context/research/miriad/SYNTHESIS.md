...
|----------|---------|----------|
| ARCHITECTURE.md | System overview, tech stack | `.kit/context/research/miriad/` |
| TYMBAL-PROTOCOL.md | Protocol deep-dive, ADAPT decision | `.kit/context/research/miriad/` |
| SHARED-BOARD-ARTIFACTS.md | Artifact types, status workflows | `.kit/context/research/miriad/` |
| AGENT-DEFINITIONS.md | Agent config, engine architecture | `.kit/context/research/miriad/` |
| CLAUDE-INTEGRATION.md | SDK analysis, session management | `.kit/context/research/miriad/` |
| NUUM-MEMORY-ARCHITECTURE.md | Memory tiers, distillation | `.kit/context/research/miriad/` |
