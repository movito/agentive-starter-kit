...
2. **Collect context**: If `--task` given, read `.agent-context/<TASK-ID>-REVIEW-STARTER.md`
...
6. **Write output**: `.agent-context/reviews/<TASK-ID>-<output_suffix>` (suffix from evaluator.yml)
