# KIT-0098: Ship the door in the package — `agentive new` / `agentive adopt`
...
**Blocks**: KIT-0099 (`project-intake` into the plugin — its "must run
...
- This task is one of the two the ADR's own WIP cap allows open at
  once (KIT-ADR-0030 D5). The other is KIT-0099.
